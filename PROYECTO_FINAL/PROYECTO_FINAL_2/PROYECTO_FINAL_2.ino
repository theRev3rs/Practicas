...
void setup() {
  ...
  Compuerta_Silo.attach(pin_Servo); // Inicia el Servo
  Compuerta_Silo.write(b);
...
switch(tecla){
  ...
  case '2': // Segunda unidad de tamizaje
   ...
   PANTALLA_ESTRADA.setCursor(0,1);
   PANTALLA_ESTRADA.print("Sirviendo: 2 lb ");
      Serial.println(capacidad);
      Compuerta_Silo.write(a);
      delay(5000);
      Compuerta_Silo.write(b);
  ...
  case '7': // boton invalido
   ...
   PANTALLA_ESTRADA.setCursor(0,1);
   Compuerta_Silo.write(a);
   PANTALLA_ESTRADA.print("    iniciando   ");
   delay(500);
   PANTALLA_ESTRADA.print("     Vaciado    ");
    break;
    case '#': // boton invalido
   PANTALLA_ESTRADA.setCursor(0,1);
   Compuerta_Silo.write(b);
   PANTALLA_ESTRADA.print("cerrando");
   delay(500);
    break;
  }
} // Final del Switch
